...
- MVP codename series and naming rules.
...
Prefer stable numbering by dependency order, not by urgency alone. Use numeric fallback directories such as `docs/mvp-01/` only when no codename series is confirmed.
